...
void HashTable::rehash()
{
   ...
   // move items from old to new (where should they go?)
   // delete old
}
...
// cStr (assumed to be currently non-existant in the hash table) so won't search first
...
{
   // hash the string, get val
   // attempt insert at val
      // if good, move on
      // if bad, quadratic probing required
